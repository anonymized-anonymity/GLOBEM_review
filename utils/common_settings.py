...
feature_types = ['f_blue', 'f_call', 'f_screen', 'f_slp', 'f_steps', 'f_loc', 'f_locMap'] # 'f_batt', 'f_calor', 'f_wifi' are not here
...
def set_feature_columns(sep = ":", epochs = epochs_5):
    ...
    fc_repo.feature_columns_fulldict = {
        ...
        "f_wifi": ['phone_wifi_connected_rapids_countscans', 'phone_wifi_connected_rapids_uniquedevices', 'phone_wifi_connected_rapids_countscansmostuniquedevice'],
